...
const Hero = () => {
  return (
    <div className="bg-slate-50 text-black flex justify-between items-center px-6 md:px-16 lg:px-24 xl:px-32 h-screen">
      <AnimateOnScroll
        direction="zoom"
        scaleLevel={0.7}
        className="pr-10 flex flex-col items-center md:items-start justify-center w-[40%] text-[#3A3A3A]"
      >
        <p className="bg-amber-500/50 text-amber-950 px-3.5 p-y rounded-full mt-20">
        ...
        <Link
          to={"/join-team"}
          className="flex items-center gap-2 text-2xl font-medium cursor-pointer mt-4 mb-5 group border rounded-full p-4 hover:bg-black/60 hover:text-amber-400 hover:border-black transition-colors duration-200"
        >
          Join Our Team{" "}
          <img
      ...
      <div className="grid grid-cols-5 gap-5 place-items-center w-[60%]">
        ...
        <div className="stream-container">
           <div
            className="w-[100px] h-[200px] rounded-[50px] mb-2 bg-blue-400"
