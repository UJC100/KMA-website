        ...
        {imagesArr.map((img, i) => (
          ...
          >
            ...
            <div className='flex flex-col justify-center gap-1'>
                ...
                <h2 className='font-playfair text-xl text-amber-600/90'>{img.occupation}</h2>
                <p className='text-sm italic text-gray-500'><span className='text-5xl opacity-50'>&quot;</span>{img.speech}&quot;</p>
