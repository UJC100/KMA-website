...
const Title = ({title, subtitle, align, font, textColor='text-blue-950'}: Props) => {
  return (
    <div className={`flex flex-col justify-center items-center text-center gap-2 ${align === "left" && "md:items-start md:text-left"}`}>
    <h1 className={`text-4xl font-bold md:text-[50px] mt-2 max-w-[1000px] ${textColor} ${font || 'font-playfair'}`}>{title}</h1>
